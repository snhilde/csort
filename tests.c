...
{
	int          nums[]   = {234, 2832, 293, -10, 139, 19, 0, -129, -19, 4, 94, 2, 34, 50, 125, 253};
	unsigned int u_nums[] = {185, 1284, 288, 23, 90, 12, 1, 985, 38, 235, 267, 23, 1, 1, 3945, 95};
